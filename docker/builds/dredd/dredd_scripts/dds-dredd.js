...
configuration = {
  ...
  //'https://apidev.dataservice.duke.edu/api/v1', // your URL to API endpoint the tests will run against
  options: {
    ...
    'header': ['Accept: application/json', 'Authorization: '.concat(process.env.apiToken)], // Array of Strings, these strings are then added as headers (key:value) to every transaction
