...
hooks.before("Authorization Roles > Authorization Roles collection > List roles", function (transaction) {
...
hooks.before("Authorization Roles > Authorization Role instance > View role", function (transaction) {
