  ...
  module V1
    class RelationsAPI < Grape::API
      ...
      desc 'Create was generated by relation' do
        detail 'Creates a WasGeneratedBy relationship. Entity can only be generated by one Activity.'
        named 'create was generated by relation'
        failure [
          [200, 'This will never actually happen'],
          [201, 'Created Successfully'],
          [400, 'Activity and Entity are required, Entity can only be generated by one Activity'],
          [401, 'Unauthorized'],
          [403, 'Forbidden']
        ]
      end
