...
describe DerivedFromFileVersionProvRelationPolicy do
  ...
  let(:visible_from_file_version) { FactoryGirl.create(:file_version, data_file: data_file) }
  let(:visible_to_file_version) { FactoryGirl.create(:file_version, data_file: data_file) }

  let(:invisible_from_file_version) { FactoryGirl.create(:file_version) }
  let(:invisible_to_file_version) { FactoryGirl.create(:file_version, data_file: invisible_from_file_version.data_file) }

  context 'destroy' do
    let(:prov_relation) { FactoryGirl.create(:derived_from_file_version_prov_relation,
